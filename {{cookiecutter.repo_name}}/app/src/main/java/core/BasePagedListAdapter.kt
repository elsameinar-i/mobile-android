...
abstract class BasePagedListAdapter(diffCallback: DiffUtil.ItemCallback<BaseEntity<Any>> = BaseDiffCallback()) : PagedListAdapter<BaseEntity<Any>, androidx.recyclerview.widget.RecyclerView.ViewHolder>(diffCallback) {
    ...
    fun setList(list: PagedList<*>?) {
        submitList(list as PagedList<BaseEntity<Any>>?)
    }
    ...
    companion object {
         ...
         */
        open class BaseDiffCallback : DiffUtil.ItemCallback<BaseEntity<Any>>() {
            override fun areItemsTheSame(oldItem: BaseEntity<Any>, newItem: BaseEntity<Any>) = oldItem == newItem
            /**
             * Note that in kotlin, == checking on data classes compares all contents, but in Java,
             * typically you'll implement Object#equals, and use it to compare object contents.
             */
            override fun areContentsTheSame(oldItem: BaseEntity<Any>, newItem: BaseEntity<Any>) = oldItem == newItem
        }
    }
}